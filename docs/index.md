...
<div class="hero-panel">
  ...
  <div class="hero-panel__visual" role="img" aria-label="夕暮れの校舎と手を差し出す人物のキービジュアル">
    <span class="hero-panel__caption">脳内ワンシーン</span>
  </div>
</div>
...
## あらすじ
1. **手** — 男子中学生の瀬田は幼馴染の煽りに反応し、変態発言で意中の女子・川原海美をドン引きさせてしまう。
2. **ハンカチ** — 授業が始まっても姿を見せない様子を心配し、教室を出た瀬田はよく見知った川原さんのハンカチを見つける。
3. **12時** — 川原さんを追って体育館を訪れる瀬田。体育教師に見つかりそうになり舞台下へ身を隠すと、１２時のチャイムが新たな展開を呼ぶ。
4. **ちくわ** — 倉庫に用具を取りに来た幼馴染の横野から隠れるため咄嗟にあるものに身を隠す瀬田だったが、自力で脱出できなくなる。
5. **嘘** — 嘘を巡る仕掛けと、横野に差し伸べられた手をどう受け入れるかを検討中。
